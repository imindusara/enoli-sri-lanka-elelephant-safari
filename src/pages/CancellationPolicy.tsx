      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-white p-8 sm:p-12 rounded-3xl border border-gray-200 shadow-sm space-y-6">
          ...
          <div className="space-y-4 text-charcoal-light text-xs sm:text-sm leading-relaxed">
            ...
            <h3 className="font-serif font-bold text-lg text-primary mt-6">1. Cancellation Timelines</h3>
            ...
            <h3 className="font-serif font-bold text-lg text-primary mt-6">2. Hotel Bookings & Train Tickets</h3>
            ...
            <h3 className="font-serif font-bold text-lg text-primary mt-6">3. Weather Delays & Force Majeure</h3>
