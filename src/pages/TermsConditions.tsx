      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-white p-8 sm:p-12 rounded-3xl border border-gray-200 shadow-sm space-y-6">
          ...
          <div className="space-y-4 text-charcoal-light text-xs sm:text-sm leading-relaxed">
            ...
            <h2 className="font-serif font-bold text-lg text-primary mt-6">1. Agreement</h2>
            ...
            <h2 className="font-serif font-bold text-lg text-primary mt-6">2. Bookings & Confirmation</h2>
            ...
            <h2 className="font-serif font-bold text-lg text-primary mt-6">3. Price Adjustments</h2>
            ...
            <h2 className="font-serif font-bold text-lg text-primary mt-6">4. Client Liability</h2>
            ...
            <h2 className="font-serif font-bold text-lg text-primary mt-6">5. Contact Information</h2>
